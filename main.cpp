...
const static char DEVICE_NAME[] = "heart123";
    ...
    void update_sensor_value()
{
    ...
    if (button) {
        _heartrate_value = 0; // Set to 8 if button is pressed
    } else {
        _heartrate_value = 1; // Set to 19 if button is not pressed
    }

    // Update the Heart Rate Service with the new value
